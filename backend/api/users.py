...
def signup(data: UserCreate): # type: ignore 
...
@router.put("/{user_id}", response_model=UserUpdate, summary="Actualizar usuario")
...
@router.delete("/{user_id}", status_code=200, summary="Eliminar usuario")
...
@router.get("/{nombre_usuario}", response_model=UserResponse, summary="Obtener usuario por ID")
